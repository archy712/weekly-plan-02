...
`mcp__context7__resolve-library-id` 및 `mcp__context7__get-library-docs`를 사용하여 Next.js 16.2.12 최신 문서 및 베스트 프랙티스를 실시간으로 참조합니다.
...
mcp__context7__get -
  library -
  docs({
    context7CompatibleLibraryID: '/vercel/next.js/v16.2.9',
...
- `"params promise"` - Next.js 16의 params 처리 방법
...
**목표**: Next.js 16.2.12 최신 API 및 베스트 프랙티스 확인
...
#### Step 2: Context7로 Next.js 16.2.12 문서 확인
