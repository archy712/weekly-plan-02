...
export type DepartmentLogStats =
  StatsFunctions["stats_logs_by_department"]["Returns"][number];
...
export type StatusLogStats = Omit<
  StatsFunctions["stats_logs_by_status"]["Returns"][number],
  "status"
...
export type MonthlyLogTrend =
  StatsFunctions["stats_logs_monthly_trend"]["Returns"][number];
